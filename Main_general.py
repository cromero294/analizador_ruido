...
try:
    ...
    for particion in particiones:
        ...
        clfTree = cambiaClase.entrenamiento(datostrain, tree.DecisionTreeClassifier, 100, 0.5)
        clfRandom = cambiaClase.entrenamiento(datostrain, RandomForestClassifier, 100, 0.5)
    ...
    print score_final_tree/num_particiones
    print score_final_random/num_particiones
