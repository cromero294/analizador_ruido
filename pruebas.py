...
try:
    ...
    clfTree,datos_cambiados = cambiaClase.entrenamiento(datostrain, 1, 0.5)
    ...
    plotModel(datostest[:,0],datostest[:,1],datostest[:,-1],np.array(clfTree.predict(datostest)),clfTree,"Frontera Arbol Decision",dataset.getDiccionarios())

    #plt.show()
    plt.savefig("Imagenes/C_example4_mesh1.eps")
