...
try:
    ...
    clfTree,_ = cambiaClase.entrenamiento(datostrain, num_arboles, 0.5)

    plotModel(datostest[:,0],datostest[:,1],np.array(clfTree.predict(datostest)),clfTree,"Frontera 1 arbol decision",dataset.getDiccionarios())

    #plt.show()
    plt.savefig("Imagenes/example1_mesh1.eps")
